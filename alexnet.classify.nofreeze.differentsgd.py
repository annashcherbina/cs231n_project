...
def main():
    ...
    pretrained_model.save_weights("alexnet_weights_dropout_regularization_augmenteddataTintContrast.stupidsgd.hdf5",overwrite=True) 
    class_predictions=pretrained_model.predict_classes(X_test) 
    np.savetxt('alexnet_class_predictions_dropout_regularization_augmenteddataTintContrast.stupidsgd.txt',class_predictions,fmt='%i',delimiter='\t') 
    ...
    predictions=open('alexnet_class_predictions_dropout_regularization_augmenteddataTintContrast.stupidsgd.txt','r').read().split('\n') 
    ...
    entries=10000
    outf=open('alexnet_class_predictions_dropout_regularization_augmenteddataTintContrast.formatted.stupidsgd.txt','w') 
