...
def main():
    ...
    pretrained_model=pretrained_finetune('assignment3_weights_dropout_regularization_augmenteddataTintContrast.stupidsgd.hdf5',True) 
    ...
    pretrained_model.save_weights("assignment3_weights_freezeAndStack_dropout_regularization_augmenteddataTintContrast.stupidsgd.hdf5",overwrite=True) 
    class_predictions=pretrained_model.predict_classes(X_test) 
    np.savetxt('assignment3_class_predictions_freezeAndStack_dropout_regularization_augmenteddataTintContrast.stupidsgd.txt',class_predictions,fmt='%i',delimiter='\t') 
    ...
    predictions=open('assignment3_freezeAndStack_class_predictions_dropout_regularization_augmenteddataTintContrast.stupidsgd.txt','r').read().split('\n') 
    ...
    entries=10000
    outf=open('assignment3_freezeAndStack_class_predictions_dropout_regularization_augmenteddataTintContrast.formatted.stupidsgd.txt','w') 
